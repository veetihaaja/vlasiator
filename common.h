...
namespace CellParams {
   enum {
      ...
      // !! All these following moment blocks must be in the order: RHOM, RHOQ, P_11, P_22, P_33, VX, VY, VZ.
      ...
      AMR_TRANSLATE_COMM_X, /*! < Flag to include this cell in AMR pre-translate communication HERE TEMPORARILY FOR TESTING  */ 
      AMR_TRANSLATE_COMM_Y, /*! < Flag to include this cell in AMR pre-translate communication HERE TEMPORARILY FOR TESTING */
      AMR_TRANSLATE_COMM_Z, /*! < Flag to include this cell in AMR pre-translate communication HERE TEMPORARILY FOR TESTING */
